    ...
    <div className="bg-white text-[#052c17] font-sans selection:bg-green-100 selection:text-[#052c17] overflow-x-hidden">
      ...
      <main>
        ...
        <div className="bg-white pt-24 lg:pt-32 border-b border-green-50">
          <nav className="max-w-[1800px] mx-auto px-6 py-4 flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">
              ...
              <div className="lg:col-span-5 space-y-8">
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-green-600">Logistics Advantage</span>
                  </div>
                ...
                <div className="grid gap-4">
                  {[
                    ...
                    <div key={i} className="p-6 bg-[#f7faf7] rounded-2xl border border-green-100 group transition-all">
                      ...
                      <h4 className="font-black text-[9px] uppercase mb-1 tracking-widest text-slate-400">{item.label}</h4>
        ...
        <section className="py-12 lg:py-20 bg-white border-b-2 border-green-100">
          <div className="max-w-[1800px] mx-auto px-6 text-center">
            <h3 className="text-xs font-black uppercase tracking-[0.4em] text-green-600 mb-3">Client Portfolio</h3>
        ...
        <section id="katalog" className="bg-[#fcfdfc] py-12 lg:py-20 border-b-2 border-green-200 relative overflow-hidden">
          <div className="max-w-[1500px] mx-auto px-6 relative z-10">
            <div className="mb-10 text-center">
               <h3 className="text-2xl lg:text-4xl font-serif italic font-black text-[#052c17] uppercase tracking-tighter">
                  Katalog <span className="text-green-600">Terupdate.</span>
               </h3>
            </div>
        ...
        <section id="kemitraan" className="py-16 lg:py-24 bg-[#f7faf7] border-t-2 border-green-200">
          <div className="max-w-[1800px] mx-auto px-6">
            <div className="text-center mb-12">
              <span className="text-green-700 text-[11px] font-black uppercase tracking-[0.5em] mb-3 block">B2B Enterprise {city.name}</span>
              <h2 className="text-3xl lg:text-5xl font-serif italic text-[#052c17] leading-none tracking-tighter mb-6">
                Mulai <span className="text-green-600 not-italic font-sans font-bold">Kemitraan.</span>
              </h2>
            </div>
            <PartnershipForm />
            
            <div className="mt-16 flex justify-center items-center gap-6">
               <div className="h-[1px] w-20 bg-green-200" />
               <span className="text-[10px] font-black uppercase tracking-[0.4em] text-green-900">Official Partner {city.name} 2025</span>
               <div className="h-[1px] w-20 bg-green-200" />
            </div>
          </div>
        </section>
